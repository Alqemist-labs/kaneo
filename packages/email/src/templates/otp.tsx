...
const messages = {
  ...
  vi: {
    preview: "Mã xác minh Alqemist Tickets của bạn",
    title: "Mã xác minh của bạn",
    subtitle: "Nhập mã dùng một lần này để hoàn tất đăng nhập.",
    code: "là mã xác minh Alqemist Tickets của bạn.",
  ...
  ja: {
    preview: "Alqemist Tickets の確認コード",
    title: "確認コード",
    subtitle:
      "サインインを完了するには、このワンタイムコードを入力してください。",
    code: "はあなたの Alqemist Tickets 確認コードです。",
