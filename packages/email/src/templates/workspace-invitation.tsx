...
const DEFAULT_COPY: WorkspaceInvitationEmailCopy = {
  subject:
    "{{inviterName}} invited you to join {{workspaceName}} on Alqemist Tickets",
  preview: "You're invited to {{workspaceName}} on Alqemist Tickets",
  title: "Join {{workspaceName}}",
  subtitle:
    "{{inviterName}} ({{inviterEmail}}) invited you to collaborate in Alqemist Tickets.",
  ...
  footer: "Alqemist Tickets workspace invitation",
};
