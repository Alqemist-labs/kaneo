...
const messages = {
  en: {
    preview: "Sign in to Alqemist Tickets",
    title: "Your secure sign-in link",
    subtitle: "Use this link to continue to your Alqemist Tickets workspace.",
    cta: "Sign in to Alqemist Tickets",
    expiry: "This link expires in 5 minutes for your security.",
    ignore: "If you didn't request this, you can ignore this email.",
    footer: "Alqemist Tickets security email",
  },
  de: {
    preview: "Bei Alqemist Tickets anmelden",
    title: "Dein sicherer Anmeldelink",
    subtitle:
      "Verwende diesen Link, um mit deinem Alqemist Tickets-Workspace fortzufahren.",
    cta: "Bei Alqemist Tickets anmelden",
  ...
  vi: {
    preview: "Đăng nhập vào Alqemist Tickets",
    title: "Liên kết đăng nhập an toàn của bạn",
    subtitle:
      "Dùng liên kết này để tiếp tục vào không gian làm việc Alqemist Tickets.",
    cta: "Đăng nhập vào Alqemist Tickets",
  ...
  ja: {
    preview: "Alqemist Tickets にサインイン",
    title: "安全なサインインリンク",
    subtitle:
      "このリンクから Alqemist Tickets ワークスペースにアクセスできます。",
    cta: "Alqemist Tickets にサインイン",
