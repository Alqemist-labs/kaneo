...
// The fork registers view shortcuts on this page; the provider lives in main.tsx.
// Partial mock: constants/shortcuts still needs the real getModifierKeyText.
vi.mock(import("@/hooks/use-keyboard-shortcuts"), async (importOriginal) => ({
